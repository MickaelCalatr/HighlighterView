package com.idean.highlightedlabel
...
import com.idean.highlightedlabel.utils.setAllParentsClip

class HighlightedLabel @JvmOverloads constructor(
    context: Context,
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.HighlightedLabel)?.apply {
            this@HighlightedLabel.isAnimated = getBoolean(R.styleable.HighlightedLabel_animated, false)
            this@HighlightedLabel.marginStart = getDimension(R.styleable.HighlightedLabel_marginStart, 0f).toInt()
            this@HighlightedLabel.marginEnd = getDimension(R.styleable.HighlightedLabel_marginEnd, 0f).toInt()
            this@HighlightedLabel.marginTop = getDimension(R.styleable.HighlightedLabel_marginTop, 0f).toInt()
            this@HighlightedLabel.marginBottom = getDimension(R.styleable.HighlightedLabel_marginBottom, 0f).toInt()
            this@HighlightedLabel.color = getColor(R.styleable.HighlightedLabel_color, color)
            this@HighlightedLabel.animationDuration =
                getInteger(R.styleable.HighlightedLabel_animationDuration, 500).toLong()
            recycle()
        }
        post {
