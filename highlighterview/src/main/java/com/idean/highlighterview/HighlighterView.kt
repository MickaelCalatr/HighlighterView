...
import com.idean.highlighterview.utils.setAllParentsClip

class HighlighterView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.HighlightedLabel)?.apply {
            this@HighlighterView.isAnimated = getBoolean(R.styleable.HighlightedLabel_animated, false)
            this@HighlighterView.marginStart = getDimension(R.styleable.HighlightedLabel_marginStart, 0f).toInt()
            this@HighlighterView.marginEnd = getDimension(R.styleable.HighlightedLabel_marginEnd, 0f).toInt()
            this@HighlighterView.marginTop = getDimension(R.styleable.HighlightedLabel_marginTop, 0f).toInt()
            this@HighlighterView.marginBottom = getDimension(R.styleable.HighlightedLabel_marginBottom, 0f).toInt()
            this@HighlighterView.color = getColor(R.styleable.HighlightedLabel_color, color)
            this@HighlighterView.animationDuration =
